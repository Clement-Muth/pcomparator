import type { CreateStore, Store } from "~/applications/Products/Domain/Entities/Store";
import type { StoreRepository } from "~/applications/Products/Domain/Repositories/StoreRepository";
